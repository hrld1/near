...
export const DARES = [
  ...
  "Foto del cielo desde donde estais, ahora.",
  ...
  "Escribid el titular de periodico de vuestro dia de hoy.",
  ...
  "Escribid vuestro plan perfecto para el proximo reencuentro en 4 pasos.",
  "Mandad la ultima cancion que os hizo pensar en el otro."
];
...
export const QUESTIONS = [
  ...
  "Que detalle pequeno mio crees que nadie mas nota?",
  ...
  "Que cosa mia te saco de quicio esta semana? (con carino)",
  "Cual fue la ultima vez que te rei solo/a recordando algo nuestro?",
  "Que le dirias a la version de ti de justo antes de conocernos?",
  "Que apodo secreto me pondrias hoy y por que?",
  "Si nuestra relacion tuviera banda sonora esta semana, que cancion seria?",
...
export const GESTURES = [
  ...
  "Enviad un 'pensando en ti' en el momento mas inesperado del dia.",
  ...
  "Escribid al despertar manana el primer mensaje antes de mirar nada mas.",
  ...
  "Hoy, ultima nota de voz del dia en vez de ultimo texto."
];
